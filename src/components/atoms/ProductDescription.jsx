    ...
    <div className="h-[400px] mt-4">
      <div className="bg-[#0795ff] h-20">
        <div className="flex items-center pt-3 px-4 text-white ">
          <h3 className="text-lg font-bold">Abon Tongkol</h3>
          <p className="mx-2">|</p>
      ...
      <div className="relative z-10 -top-7 bg-gradient-to-b from-white from-90% to-[#fafafa] rounded-t-3xl p-6 h-full">
        ...
        <div>
          <div className="flex gap-1 items-center mt-1">
            ...
            <p className="text-sm opacity-70 ">PT Upin Ipin</p>
          </div>
          <div className="flex gap-1 items-center">
            ...
            <p className="text-sm opacity-70">PT Kembar</p>
          </div>
        ...
        <div className="mt-3">
          ...
          <p className="text-xs mt-1 text-justify">
            ...
            earum optio accusantium eos sequi pariatur fugit repellendus error
            eveniet quas, aut voluptatibus magni sunt! Excepturi, in blanditiis?
            Exercitationem, at quam!
          </p>
        </div>
      </div>
    </div>
